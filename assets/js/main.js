...
sr.reveal(`.about__data, .join__image, .currency__image, .weather__video`, { origin: 'right' })
sr.reveal(`.about__image, .join__data, .currency__data, .weather__data`, { origin: 'left' })
