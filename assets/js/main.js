...
//varaibles targeting HTML elements
...
form.addEventListener("submit", function travelInfo(event) {
  ...
  fetch(tripLocation)
    ...
    .then(function returnLocation(data) {
      ...
      var locationMap = `https://maps.geoapify.com/v1/staticmap?style=osm-bright&width=600&height=400&format=jpeg&center=lonlat:${locationLon},${locationLat}&zoom=13.5&apiKey=e4ecef705ece4451a30f714a57fb5101`;
